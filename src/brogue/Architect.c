...
reverseItemEntry reverseTable[NUMBER_ITEM_CATEGORIES] = {
    ...
    { "potion",     POTION, potionTable, NUMBER_POTION_KINDS, },
    { "scroll",     SCROLL, scrollTable, NUMBER_SCROLL_KINDS, },
    { "staff",      STAFF,  staffTable,  NUMBER_STAFF_KINDS,  },
    { "wand",       WAND,   wandTable,   NUMBER_WAND_KINDS,   },
    { "ring",       RING,   ringTable,   NUMBER_RING_KINDS,   },
    { "charm",      CHARM,  charmTable,  NUMBER_CHARM_KINDS,  },
    { "gold",       GOLD,   NULL,        0,                   },
