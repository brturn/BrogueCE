...
var ASM_CONSTS = {
  873600: ($0) => { FS.syncfs($0, function(err) { if (err) { console.warn("Error syncing files:", err); } else { console.log("FS synced IndexedDB"); } }); },  
 873739: () => { uiModeInMenu() },  
 873754: () => { uiModeShowEscape() },  
 873773: ($0) => { uiModeShowKeyboardAndEscape($0) },  
 873807: () => { uiModeInNormalPlay() },  
 873828: ($0) => { const nxt = window.keyOrMouseEvents.shift(); if(nxt){ _javascript_receiveNextKeyOrMouseEvent.apply(null, nxt); } else { _javascript_receiveNextKeyOrMouseEvent($0, 0, 0, 0, 0); } },  
 874010: () => { return Math.min(window.keyOrMouseEvents.length, 1); },  
 874066: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => { plotChar([$0,$1,$2,$3,$4,$5,$6,$7,$8]); }
};
