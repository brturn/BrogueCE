...
var ASM_CONSTS = {
  120160: ($0) => { FS.syncfs($0, function(err) { if (err) { console.warn("Error syncing files:", err); } else { console.log("FS synced IndexedDB"); } }); },  
 120299: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => { plotChar([$0,$1,$2,$3,$4,$5,$6,$7,$8]); },  
 120343: () => { return Math.min(window.keyOrMouseEvents.length, 1); },  
 120399: ($0) => { const nxt = window.keyOrMouseEvents.shift(); if(nxt){ _javascript_receiveNextKeyOrMouseEvent.apply(null, nxt); } else { _javascript_receiveNextKeyOrMouseEvent($0, 0, 0, 0, 0); } }
};
